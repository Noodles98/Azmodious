...
const int LATE_GAME_FRAME = 28 * MINUTE;
...
const float EARLY_DEFENCE_LANE_SPREAD = 800.0f;
const float MID_DEFENCE_LANE_SPREAD = 900.0f;
const float LATE_DEFENCE_LANE_SPREAD = 1000.0f;
...
const float FIRST_ADV_AIR_MAX_BASE_DISTANCE = 775.0f;
