...
const float EARLY_CONVERT_EFF = 12.15f;
...
const float EARLY_DEFENCE_METAL_INCOME_MIN = 7.0f;
const float MID_DEFENCE_METAL_INCOME_MIN = 16.0f;
const float LATE_DEFENCE_METAL_INCOME_MIN = 40.0f;
