...
const float MID_DEFENCE_METAL_INCOME_MIN = 18.0f;
const float LATE_DEFENCE_METAL_INCOME_MIN = 25.0f;
const float EARLY_DEFENCE_LANE_SPREAD = 850.0f;
const float MID_DEFENCE_LANE_SPREAD = 675.0f;
const float LATE_DEFENCE_LANE_SPREAD = 560.0f;
const uint MILITARY_SCOUT_CAP = 3;
const float MILITARY_ATTACK_THRESHOLD = 45.0f;
const float MILITARY_RAID_MIN_POWER = 15.0f;
const float MILITARY_RAID_AVG_POWER = 55.0f;
