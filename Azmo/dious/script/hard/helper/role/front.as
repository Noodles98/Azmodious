...
const float EARLY_CONVERT_EFF = 11.22f;
...
const float EARLY_DEFENCE_LANE_SPREAD = 450.0f;
const float MID_DEFENCE_LANE_SPREAD = 520.0f;
const float LATE_DEFENCE_LANE_SPREAD = 580.0f;
const uint MILITARY_SCOUT_CAP = 2;
const float MILITARY_ATTACK_THRESHOLD = 160.0f;
const float MILITARY_RAID_MIN_POWER = 15.0f;
const float MILITARY_RAID_AVG_POWER = 60.0f;
