...
const float MID_ASSIST_METAL_RATIO = 0.24f;
const float LATE_ASSIST_METAL_RATIO = 0.30f;
const float EARLY_FACTORY_SWITCH_ARMY_MULT = 1.35f;
const float MID_FACTORY_SWITCH_ARMY_MULT = 1.56f;
const float LATE_FACTORY_SWITCH_ARMY_MULT = 1.72f;
...
const float MILITARY_RAID_MIN_POWER = 35.f;
const float MILITARY_RAID_AVG_POWER = 95.f;
...
const int FRONTLINE_ANCHOR_EXPIRE = 150 * SECOND;
