...
const float MID_DEFENCE_METAL_INCOME_MIN = 18.f;
const float LATE_DEFENCE_METAL_INCOME_MIN = 25.f;
const float EARLY_DEFENCE_LANE_SPREAD = 850.f;
const float MID_DEFENCE_LANE_SPREAD = 675.f;
const float LATE_DEFENCE_LANE_SPREAD = 560.f;
