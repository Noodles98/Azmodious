...
void RegisterAll()
{
	...
	array<TeamMapProfileTypes::StartSpot> all_that_glittersSpots = {
		TeamMapProfileTypes::StartSpot(AIFloat3(668, 0, 755), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(2801, 0, 775), "air", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(4211, 0, 609), "tech", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(5762, 0, 600), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(1159, 0, 1943), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(3061, 0, 1967), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(4298, 0, 1996), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(5472, 0, 2030), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(5475, 0, 9444), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(3452, 0, 9689), "air", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(1943, 0, 9622), "tech", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(408, 0, 9640), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(5166, 0, 8246), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(3212, 0, 8249), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(1859, 0, 8256), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(697, 0, 8224), "front", false),
	};
	...
	array<TeamMapProfileTypes::StartSpot> ancient_bastion_remakeSpots = {
		...
		TeamMapProfileTypes::StartSpot(AIFloat3(2800, 0, 5400), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(4100, 0, 6600), "front", false),
		TeamMapProfileTypes::StartSpot(AIFloat3(10700, 0, 4300), "front", false),
	};
