namespace TeamMapProfileData_supreme_isthmus_v2_1 {
...
void Register()
{
    ...
    TeamMapProfileTypes::StartSpot(AIFloat3(11600, 0, 5000), "tech", false),
    TeamMapProfileTypes::StartSpot(AIFloat3(730, 0, 7300), "tech", false),
    ...
    TeamMapProfileTypes::StartSpot(AIFloat3(11400, 0, 1900), "tech", false),
    TeamMapProfileTypes::StartSpot(AIFloat3(900, 0, 10400), "tech", false),
    ...
    TeamMapProfileRegistry::Register(TeamMapProfileTypes::Profile("Supreme Isthmus v2.1", spots));
}
